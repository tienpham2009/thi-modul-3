...
<body>
<div class="container">
    <form action="{{ route('update' , $agency->id) }}" method="post">
        @csrf
        <div class="row">
            <div class="col-6">
                <div class="form-group">
                    <label for="exampleInputEmail1">Ma so dai li</label>
                    <input type="text" class="form-control" name="code" value="{{ $agency->code }}">
                    @error('code')
            ...
            <div class="col-6">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="manger_name" value="{{ $agency->manger_name }}">
                    @error('manger_name')
                    <p class="text-danger">{{ $message }}</p>
                    @enderror
                </div>
        ...
        <a href="{{ route('show') }}" type="submit" class="btn btn-primary">Submit</a>
    </form>
</div>
<!-- Optional JavaScript -->
